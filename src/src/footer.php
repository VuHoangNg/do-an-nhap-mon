...
<section id="lh" class="footer">
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <h3><strong>CÔNG TY CỔ PHẦN TÀU Hỏa VHL Team</strong></h3>
            <br>  
            <ul>
			  <li><strong>Văn phòng đại diện TP.HCM</strong></li>
			  <li><strong>Địa Chỉ:</strong> 45 Nguyễn Khắc Nhu, Phường Cô Giang, Quận 1, Thành phố Hồ Chí Minh </li>
			  <li><strong>Phone:</strong> 0123.456.789</li></ul>
        ...
        <div class="col-sm-3">
            ...
            <ul>
              <li style="color:white"><a href="mailto:vu.187it07023@vanlanguni.vn"><p style="color:white">vu.187it07023@vanlanguni.vn</p></a></li>
            <li>0945.199.786</li></ul>
...
<section class="copyright">
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <div class="copyrightInner"><strong></strong></div>
      </div>
    </div>
  </div>
</section>
